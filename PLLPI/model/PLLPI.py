...
class DeepFeatureExtractor(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim=64, num_layers=8):
...
class PLLPI(nn.Module):
    ...
    def __init__(self, lncrna_dim=128, protein_dim=128, hidden_dim=64):
        super(PLLPI, self).__init__()
        self.lncrna_dim = lncrna_dim
        self.protein_dim = protein_dim

        # 深度特征提取器
        self.lncrna_feature_extractor = DeepFeatureExtractor(lncrna_dim, hidden_dim)
        self.protein_feature_extractor = DeepFeatureExtractor(protein_dim, hidden_dim)
